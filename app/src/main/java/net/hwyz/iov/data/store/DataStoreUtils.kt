package net.hwyz.iov.data.store
...
import net.hwyz.iov.data.store.DataStoreUtils.clear
import net.hwyz.iov.data.store.DataStoreUtils.clearSync
import net.hwyz.iov.data.store.DataStoreUtils.getData
import net.hwyz.iov.data.store.DataStoreUtils.getSyncData
import net.hwyz.iov.data.store.DataStoreUtils.putData
import net.hwyz.iov.data.store.DataStoreUtils.putSyncData
import net.hwyz.iov.data.store.DataStoreUtils.readBooleanData
import net.hwyz.iov.data.store.DataStoreUtils.readBooleanFlow
import net.hwyz.iov.data.store.DataStoreUtils.readFloatData
import net.hwyz.iov.data.store.DataStoreUtils.readFloatFlow
import net.hwyz.iov.data.store.DataStoreUtils.readIntData
import net.hwyz.iov.data.store.DataStoreUtils.readIntFlow
import net.hwyz.iov.data.store.DataStoreUtils.readLongData
import net.hwyz.iov.data.store.DataStoreUtils.readLongFlow
import net.hwyz.iov.data.store.DataStoreUtils.readStringData
import net.hwyz.iov.data.store.DataStoreUtils.readStringFlow
import net.hwyz.iov.data.store.DataStoreUtils.saveBooleanData
import net.hwyz.iov.data.store.DataStoreUtils.saveFloatData
import net.hwyz.iov.data.store.DataStoreUtils.saveIntData
import net.hwyz.iov.data.store.DataStoreUtils.saveLongData
import net.hwyz.iov.data.store.DataStoreUtils.saveStringData
import net.hwyz.iov.data.store.DataStoreUtils.saveSyncBooleanData
import net.hwyz.iov.data.store.DataStoreUtils.saveSyncFloatData
import net.hwyz.iov.data.store.DataStoreUtils.saveSyncIntData
import net.hwyz.iov.data.store.DataStoreUtils.saveSyncLongData
import net.hwyz.iov.data.store.DataStoreUtils.saveSyncStringData
...
object DataStoreUtils {
    ...
    private const val preferenceName = "IovDataStore"
